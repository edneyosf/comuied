...
private val COLOR_DARK = Colors.LIGHT1.copy(alpha = 0.5f)
private val COLOR_LIGHT = Colors.DARK5.copy(alpha = 0.4f)
...
@Composable
fun Titled(text: String, darkTheme: Boolean = isSystemInDarkTheme()){
